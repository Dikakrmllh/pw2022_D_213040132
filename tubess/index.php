...
$db_store = query("SELECT * FROM asus_data");
...
<head>
  ...
  <title>Capital Store</title>
</head>

<body>

  <div class="container">
    <h1 class="align-midcle">Capital Store</h1>
      ...
      <div class="tab-pane active" role="tabpanel" id="tab-1">
        <div class="card-group">
          <div class="container-fluid">
            <div class="row">
              <?php foreach ($db_store as $row) : ?>
                <div class="col-md-4">
                  <div class="card shadow mt-3">
                    <img class="card-img-top img-fluid max-foto" src="img/<?= $row['gambar']; ?>" style="max-height: 300px; min-height: 300px;">
                    <div class="card-body">
